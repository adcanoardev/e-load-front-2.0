                    ...
                    <Flex gap={10}>
                        <Flex width={200} direction="column" gap={3}>
                            <Flex alignItems="center" justifyContent={"space-between"}>
                                ...
                                <Select {...register("power")} width={200} defaultValue={"Opción"}>
                            ...
                            <Flex alignItems="center" justifyContent={"space-between"}>
                                ...
                                <Select {...register("type")} width={200} defaultValue={"Opción"}>
                                    <option disabled value="Opción">
                                        Opción
                                    </option>
                            ...
                            <Flex alignItems="center" justifyContent={"space-between"}>
                                ...
                                <Input {...register("rate")} placeholder="0.0" maxLength={6} width={20} />
                            </Flex>
                            <Flex alignItems="center" justifyContent={"space-between"}>
                                <FormLabel>Estado</FormLabel>
                                <Select {...register("state")} width={200} defaultValue={"Opción"}>
                                    <option disabled value="Opción">
                                        Opción
                                    </option>
                        ...
                        <Flex direction={"column"}>
                            ...
                            <Divider mb={3} />
                            <Select {...register("station")} defaultValue={"Dirección"}>
                                <option disabled value="Dirección">
                                    Dirección
                                </option>
